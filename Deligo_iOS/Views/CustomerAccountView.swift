            ...
            List {
                if isLoading {
                    ...
                    Section(header: Text("Account Settings")) {
                        NavigationLink(destination: AddressManagementView(authViewModel: authViewModel)) {
                            Label("Saved Addresses", systemImage: "mappin.and.ellipse")
                        }
                        
                        NavigationLink(destination: PaymentMethodsView(authViewModel: authViewModel)) {
